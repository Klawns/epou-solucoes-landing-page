 ...
 *
 * The `cva` function from `class-variance-authority` is used to create variants
 * for different button styles, sizes, and states.
 */
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 cursor-pointer",
  {
    variants: {
      ...
      variant: {
        default:
          "bg-primary text-primary-foreground hover:bg-gray-800 shadow-lg hover:shadow-xl cursor-pointer",
        destructive:
        ...
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-gray-200 cursor-pointer",
        ghost: "hover:bg-accent hover:text-accent-foreground cursor-pointer",
        link: "text-primary underline-offset-4 hover:underline cursor-pointer",
        hero: "bg-primary text-primary-foreground hover:bg-gray-800 shadow-lg hover:shadow-2xl hover:-translate-y-0.5 text-base px-8 py-6 cursor-pointer",
      },
      /**
