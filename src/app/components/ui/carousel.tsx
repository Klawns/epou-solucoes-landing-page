...
type CarouselProps = {
  ...
  /**
   * A callback to get the Embla Carousel API.
   */
 ...
 *
 * This hook must be used within a `<Carousel />` component.
 *
 ...
 *
 * This component is a wrapper around the Embla Carousel library. It provides a
 * context for its children to access the carousel's API and state.
 *
 ...
 *
 * This component is a wrapper for the carousel's slides.
 *
